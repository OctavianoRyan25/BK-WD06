...
@section('title', 'Poliklinik - Tambah pasien')
@section('content')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Tambah Pasien</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="container w-full">
        <div class="px-6 py-10 bg-white shadow-lg rounded-lg mt-3 mx-3">
            <div class="mb-6 text-center">
                <h1 class="text-3xl font-bold text-gray-800">Tambah Pasien</h1>
                <p class="text-gray-600 text-sm mt-2">Isi informasi Pasien dengan lengkap untuk menambah data baru.</p>
            </div>
            {{-- looping error --}}
            @if ($errors->any())
            ...
            <form action="{{ route('admin.pasien.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="no_ktp" class="block text-sm font-semibold text-gray-700">KTP</label>
