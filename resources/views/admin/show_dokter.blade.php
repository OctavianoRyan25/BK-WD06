        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Detail Dokter</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="container w-full">
        <div class="px-6 py-10 bg-white shadow-lg rounded-lg mt-3 mx-3">
            <div class="mb-6 text-center">
                ...
                <p class="text-gray-600 text-sm mt-2">Informasi dokter dengan lengkap.</p>
            </div>
            {{-- looping error --}}
            @if ($errors->any())
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="nama" id="nama" autocomplete="off"
                            ...
                            required value="{{ $dokter->nama }}" disabled>
                    </div>
                    <div>
                        <label for="id_poli" class="block text-sm font-semibold text-gray-700">Poli</label>
                        <input name="id_poli" id="id_poli"
                            class="mt-2 focus:ring-teal-500 focus:border-teal-500 block w-full shadow-sm text-sm bg-gray-300 border-gray-300 rounded-lg py-2 px-3"
                            value="{{ $dokter->poli->nama_poli }}" disabled selected>
                        </input>
                    </div>
                    <div>
                        ...
                        <textarea name="alamat" id="alamat" autocomplete="off" rows="3" placeholder="Masukkan alamat dokter"
                            ...
                            required disabled>{{ $dokter->alamat }}</textarea>
                    </div>
                    <div>
                        ...
                        <input type="tel" name="no_hp" id="no_hp" autocomplete="off"
                            ...
                            class="mt-2 focus:ring-teal-500 focus:border-teal-500 block w-full shadow-sm text-sm bg-gray-300 border-gray-300 rounded-lg py-2 px-3 placeholder-gray-400"
                            required value="{{ $dokter->no_hp }}" disabled>
                    </div>
                </div>
