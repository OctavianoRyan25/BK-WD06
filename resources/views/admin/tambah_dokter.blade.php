    ...
    <div class="container w-full">
        <div class="px-6 py-10 bg-white shadow-lg rounded-lg mt-3 mx-3">
            <div class="mb-6 text-center">
                <h1 class="text-3xl font-bold text-gray-800">Tambah Dokter</h1>
                <p class="text-gray-600 text-sm mt-2">Isi informasi dokter dengan lengkap untuk menambah data baru.</p>
            </div>
            {{-- looping error --}}
            @if ($errors->any())
