...
<head>
    ...
    <title>Login Dokter Page</title>
    <link rel="icon" href="{{ asset('assets/logo-udinus.png') }}" type="image/x-icon">
</head>

<body>
    @include('sweetalert::alert')
    <form method="POST" action="{{ route('dokter.handlelogin') }}">
        @csrf
                        ...
                        <div class="w-full flex-1 mt-3">
                            <div class="my-6 border-b text-center">
                                ...
                                <input
                                    ...
                                    type="nama" placeholder="Nama" name="nama" value="{{ old('nama') }}" />
                                <input
                                    class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5"
                                    type="password" placeholder="Alamat" name="alamat" />
                                <button type="submit"
